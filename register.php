        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 mb-5">
                    ...
                    <form action="actions/register_user_action.php" class="p-4 border rounded shadow" novalidate>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <input type="submit" value="Sign Up" class="btn px-4 btn-primary text-white" id="submitBtn">
                            </div>
                        </div>
